	...
	'relative w-full rounded-lg border border-neutral-200 p-4 [&>svg~*]:pl-7 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-neutral-950 dark:border-neutral-800 dark:[&>svg]:text-neutral-50',
	{
		variants: {
			variant: {
				...
				destructive:
					'border-red-500/50 text-red-500 dark:border-red-400 [&>svg]:text-red-500 dark:border-red-400/50 dark:text-red-400 dark:dark:border-red-400 dark:[&>svg]:text-red-400',
			},
		},
		defaultVariants: {
			variant: 'default',
